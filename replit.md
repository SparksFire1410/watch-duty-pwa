...
- **Speech-to-Text Transcription**: Uses faster-whisper AI to transcribe dispatch audio and detect fire keywords
  ...
  - Detects: grass fire/on fire, brush fire/on fire, wildland fire, wildfire, natural cover fire, vegetation fire/on fire, pasture fire/on fire, hay field fire, hay fire/on fire, ditch fire/on fire, tree fire, trees on fire, bush fire/on fire, bushes on fire, controlled burn, out of control burn, smoke, smoking, structure(s) in danger, structure(s) threatened (all variations)
...
- Implemented fire keyword detection from audio transcripts (grass fire, brush fire, wildland fire, wildfire, natural cover fire, vegetation fire, pasture fire, hay field fire, hay fire, ditch fire, tree fire, trees on fire, bush fire, bushes on fire, controlled burn, out of control burn, smoke)
